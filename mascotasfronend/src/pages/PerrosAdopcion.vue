<template>
    <div id="lista-cursos" class="container">
        <h1 id="encabezado" class="encabezado">Lista de perros en adopcion</h1>
...
<!-- Modal -->
    ...
    <div class="modal fade" id="staticBackdropA" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="container"  v-for="mascota in mascotas" :key="mascota.id">
            <div class="row" v-if="mascota.idTipoAnimal == 1">
    ...
    export default {
      name: 'lista-mascotas',
        ...
        methods: { 
            async getMascotas() {
            try {
                const respuesta = await fetch("http://localhost:5000/mascotass/2", {
                method: "GET",
                headers: {
